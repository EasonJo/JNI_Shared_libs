...
public:
    ...
    Divide(const std::shared_ptr<vrtf::vcc::Proxy>& proxy, const ara::com::internal::EntityId entityId): method_(proxy, entityId){}
...
public:
    ...
    add(const std::shared_ptr<vrtf::vcc::Proxy>& proxy, const ara::com::internal::EntityId entityId): method_(proxy, entityId){}
    void Initialize(const std::shared_ptr<vrtf::vcc::Proxy>& proxy, const ara::com::internal::EntityId entityId)
    {
        method_.Initialize(proxy, entityId);
    }
...
public:
    ...
    substract(const std::shared_ptr<vrtf::vcc::Proxy>& proxy, const ara::com::internal::EntityId entityId): method_(proxy, entityId){}
    void Initialize(const std::shared_ptr<vrtf::vcc::Proxy>& proxy, const ara::com::internal::EntityId entityId)
    {
        method_.Initialize(proxy, entityId);
    }
...
public:
    ...
    explicit CalculatorInterfaceProxy(const vrtf::vcc::api::types::HandleType &handle)
        : proxyAdapter(std::make_unique<ara::com::internal::proxy::ProxyAdapter>(::huawei::CalculatorInterface::ServiceIdentifier, handle)),
          DividedByZero(proxyAdapter->GetProxy(), events::CalculatorInterfaceDividedByZeroId, proxyAdapter->GetHandle(), ::huawei::CalculatorInterface::ServiceIdentifier),
          ...
          DivideResult(proxyAdapter->GetProxy(), fields::CalculatorInterfaceDivideResultId, proxyAdapter->GetHandle(), ::huawei::CalculatorInterface::ServiceIdentifier) {
            ara::core::Result<void> resultDivide = proxyAdapter->InitializeMethod<methods::Divide::Output>(methods::CalculatorInterfaceDivideId);
            ThrowError(resultDivide);
            ara::core::Result<void> resultadd = proxyAdapter->InitializeMethod<methods::add::Output>(methods::CalculatorInterfaceaddId);
            ThrowError(resultadd);
            ara::core::Result<void> resultsubstract = proxyAdapter->InitializeMethod<methods::substract::Output>(methods::CalculatorInterfacesubstractId);
        ...
        const vrtf::vcc::api::types::HandleType &handle)
    {
        ...
        do {
            ...
            initResult = preProxyAdapter->InitializeMethod<methods::Divide::Output>(methods::CalculatorInterfaceDivideId);
            if (!initResult.HasValue()) {
                result = false;
                break;
            }
            const methods::add add(preProxyAdapter->GetProxy(), methods::CalculatorInterfaceaddId);
            initResult = preProxyAdapter->InitializeMethod<methods::add::Output>(methods::CalculatorInterfaceaddId);
            if (!initResult.HasValue()) {
                result = false;
                break;
            }
            const methods::substract substract(preProxyAdapter->GetProxy(), methods::CalculatorInterfacesubstractId);
            initResult = preProxyAdapter->InitializeMethod<methods::substract::Output>(methods::CalculatorInterfacesubstractId);
            if (!initResult.HasValue()) {
                result = false;
                break;
            }
            fields::DivideResult DivideResult(preProxyAdapter->GetProxy(), fields::CalculatorInterfaceDivideResultId, handle, ::huawei::CalculatorInterface::ServiceIdentifier);
            DivideResult.SetSetterEntityId(fields::CalculatorInterfaceDivideResultSetterId);
            DivideResult.SetGetterEntityId(fields::CalculatorInterfaceDivideResultGetterId);
    ...
    {
        return ara::com::internal::proxy::ProxyAdapter::StartFindService(handler, ::huawei::CalculatorInterface::ServiceIdentifier, instance);
    }
    ...
    {
        return ara::com::internal::proxy::ProxyAdapter::StartFindService(handler, ::huawei::CalculatorInterface::ServiceIdentifier, specifier);
    }

    static ara::com::ServiceHandleContainer<ara::com::internal::proxy::ProxyAdapter::HandleType> FindService(
        const ara::com::InstanceIdentifier instance)
    {
        return ara::com::internal::proxy::ProxyAdapter::FindService(::huawei::CalculatorInterface::ServiceIdentifier, instance);
    }

    static ara::com::ServiceHandleContainer<ara::com::internal::proxy::ProxyAdapter::HandleType> FindService(
        const ara::core::InstanceSpecifier specifier)
    {
        return ara::com::internal::proxy::ProxyAdapter::FindService(::huawei::CalculatorInterface::ServiceIdentifier, specifier);
    }
